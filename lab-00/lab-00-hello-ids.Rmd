...
```{marginfigure}
**Note:** From next week's lab onwards, your repository will contain your teamname instead (e.g. lab-01-plastic-waste-example_team). Also you will not be able to see other teams' repositories (for obvious reasons).
```
